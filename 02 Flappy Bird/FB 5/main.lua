...
function love.update(dt)
  ...
  if timerPipes > intervalPipes then
    -- add an instance of the pipe class to the table
    -- through the table.insert() function
  ...
  for key, pipe in pairs(pipes) do
    ...
    -- if the horizontal coordinate of the pipe reaches the left edge of the screen remove the specific pipe from the table
