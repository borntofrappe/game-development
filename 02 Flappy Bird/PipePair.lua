...
--[[
  ...
  - y, passed in the declaration of the instance and representing the coordinate of the pipes
  - gap, passed in the declaration of the instance and representing the gap between the two pipes
...
function PipePair:init(y, gap)
  ...
  self.remove = false
  -- add a boolean for scored, to signal when the pipe is to the left of the bird
  self.scored = false
end
