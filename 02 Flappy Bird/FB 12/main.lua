...
push = require 'Resources/lib/push'
--[[
...
Class = require 'Resources/lib/class'
...
local background = love.graphics.newImage('Resources/graphics/background.png')
local ground = love.graphics.newImage('Resources/graphics/ground.png')
...
function love.load()
  ...
  normalFont = love.graphics.newFont('Resources/fonts/font.ttf', 16)
  bigFont = love.graphics.newFont('Resources/fonts/font.ttf', 48)
  hugeFont = love.graphics.newFont('Resources/fonts/font.ttf', 64)
  -- by default use the normal font
  love.graphics.setFont(normalFont)

  -- add a table with the sound files
  sounds = {
    ['countdown'] = love.audio.newSource('Resources/sounds/countdown.wav', 'static'),
  ...
  -- add a table in which to keep track of the mouse coordinates
  love.mouse.coor = {
    ['x'] = 0,
    ['y'] = 0
  }
...
-- when pressing the mouse retrieve the x and y coordinates and update the values stored in the love.mouse.coor table
function love.mousepressed(x, y)
  -- ! as we introduce a virtualization through the push library, be sure to take the mouse coordinates and convert them to virtual coordinates
  -- the push:toGame() function takes as argument an x an y and returns virtual x and virtual x
...
function love.update(dt)
  ...
  -- reset the coordinates of love.mouse
