...
function love.load()
  ...
  - scroll to move it horizontally
...
function love.update(dt)
  ...
  if love.keyboard.isDown('left') then
    ...
    gCharacter.scroll = gCharacter.scroll - CHARACTER_SCROLL_SPEED * dt
...
function love.draw()
  ...
  love.graphics.draw(
    ...
    VIRTUAL_WIDTH / 2 - CHARACTER_WIDTH / 2 + gCharacter.offset + math.floor(gCharacter.scroll),
