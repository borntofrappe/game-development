...
function PlayerFallingState:update(dt)
  ...
  local tileBottomLeft = self.player.tileMap:pointToTile(self.player.x + 2, self.player.y + self.player.height)
  local tileBottomRight =
    self.player.tileMap:pointToTile(self.player.x + self.player.width - 2, self.player.y + self.player.height)
