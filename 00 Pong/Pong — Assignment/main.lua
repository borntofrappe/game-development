...
function love.draw()
  ...
  if gameState == "playing" then
    love.graphics.printf("Press enter to stop", 0, VIRTUAL_HEIGHT / 24, VIRTUAL_WIDTH, "center")
  else
    love.graphics.printf("Press enter to play", 0, VIRTUAL_HEIGHT / 24, VIRTUAL_WIDTH, "center")
  end
  ...
  love.graphics.printf(tostring(computer.points), VIRTUAL_WIDTH / 4, VIRTUAL_HEIGHT / 5, VIRTUAL_WIDTH / 4, "center")

  love.graphics.printf(tostring(player.points), VIRTUAL_WIDTH / 2, VIRTUAL_HEIGHT / 5, VIRTUAL_WIDTH / 4, "center")
