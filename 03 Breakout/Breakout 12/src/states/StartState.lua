...
function StartState:update(dt)
  ...
  -- on the enter key, to go to the paddle select state
  -- ! pass to the paddle select state the variables referencing the paddle, the bricks, as well as the health and the score
  -- ! call the paddle select state **or** the high score state, depending on the current selection
