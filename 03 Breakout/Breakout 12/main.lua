...
function love.load()
  ...
  --[[
    ...
    - the balls retrieved from breakout.png and through GenerateQuadsBalls()
    - the bricks retrieved from breakout.png and through GenerateQuadsBricks()
    - the hearts retrieved from hearts.png and through GenerateQuads()
    - the arrows retrieved from arrows.png and through GenerateQuads()
  ]]
  gFrames = {
  ...
  -- load the high scores and store them in a global variable
...
function displayHealth(health)
  ...
  -- describe max health (which is the starting value for health)
  maxHealth = 3
...
function loadHighScores()
  ...
  -- breakout.lst exist (whether created above or already available locally)
  -- read the file to create a table with the players names and scores
  -- initialize a table in which to show the scores
  local highScores = {}
