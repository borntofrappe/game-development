...
function PlayState:init()
  ...
  -- include an instance of the board class
  -- center the board considering the width and height of the screen and of the board
  -- the idea is to have the board vertically centered
  -- horizontally distanced from the right edge as the panel is distanced from the left
