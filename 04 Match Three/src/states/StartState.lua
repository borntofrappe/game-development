...
function StartState:init()
  ...
  -- table describing overlay used for the fadeout transition
...
function StartState:update(dt)
  ...
  if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
    ...
    -- ! before going to the play state have the screen fade to white, by increasing the opacity represented by self.fadeout.opacity
...
function StartState:render()
  ...
  -- DARKEN BACKGROUND
  -- before the drawing of the actual graphics include a semi-transparent dark overlay to have the background reduced in visual importance
  ...
  -- rectangle using self.fadeout to transition to the following state
  -- self.fadeout contains one value for each of the rgba fields coloring the rectangle
