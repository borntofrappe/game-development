...
function Android:collides(lollipop)
  if lollipop.origin == 'top' then
    if (((self.x + self.width / 2) - (lollipop.x + lollipop.width / 2)) ^ 2 + ((self.y - self.height / 2) - (lollipop.y + lollipop.height - lollipop.width / 2)) ^ 2) ^ 0.5 < lollipop.width / 2 then
      return true
    end
  else
    if (((self.x + self.width / 2) - (lollipop.x + lollipop.width / 2)) ^ 2 + (self.y - (lollipop.y + lollipop.width / 2)) ^ 2) ^ 0.5 < lollipop.width / 2 then
      return true
    end
  end
