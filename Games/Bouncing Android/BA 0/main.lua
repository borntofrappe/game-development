...
local clouds_1 = love.graphics.newImage('res/clouds-1.png')
local clouds_2 = love.graphics.newImage('res/clouds-2.png')
...
function love.draw()
    ...
    love.graphics.draw(clouds_2, 0, 0)
    love.graphics.draw(clouds_1, 0, 0)
